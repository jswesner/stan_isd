...
*Jeff S. Wesner*^1^, *Justin P.F. Pomeranz*^2^, *James R. Junker*^3,4^, *Vojsava Gjoni*^1^, *Yuhlong Lio*^5^
...
^5^University of South Dakota, Department of Mathematics, Vermillion, SD 57069

[Jeff.Wesner\@usd.edu](mailto:Jeff.Wesner@usd.edu){.email}

Keywords: *Individual Size Distributions, Body Size Spectra, Bayesian Hierarchical, Community Size Spectrum*
